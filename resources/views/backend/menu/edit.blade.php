...
<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            {!! html()->label('Menu Name','title')->class('control-label') !!}
            <span class="text-danger">*</span>
            {!! html()->text('title',$data->title)->placeholder('Type name here')->class('form-control')->id('title') !!}
        </div>
        <div class="form-group">
            {!! html()->label('Information','subtitle')->class('control-label') !!}
        ...
        <div class="form-group">
            ...
            {!! html()->select('model',$model,collect(explode('\\', $data->model))->last())->placeholder('Select Model (optional)')->class('form-control select2')->id('model') !!}
        </div>
        <div class="form-group">
            {!! html()->label('Menu Code','code')->class('control-label') !!}
            <span class="text-danger">*</span>
    ...
    <div class="col-md-6">
        ...
        <div class="form-group">
            {!! html()->label('Menu Type','type')->class('control-label') !!}
            <span class="text-danger">*</span>
            {!! html()->select('type',['' => 'Select Menu Type', 'backend' => 'Backend', 'frontend' => 'Frontend'],$data->type)->class('form-select')->id('type') !!}
        </div>
        <div class="row">
            <div class="col-md-3">
                <div class="form-group">
                    {!! html()->label('Show','show')->class('control-label') !!}
                    <span class="text-danger">*</span>
                    {!! html()->select('show',[1 => 'Yes', 0 => 'No'],$data->show)->class('form-select')->id('show') !!}
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <span class="text-danger">*</span>
                    {!! html()->select('active',[1 => 'Active', 0 => 'Inactive'],$data->active)->class('form-select')->id('active') !!}
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group">
                    {!! html()->label('Coming Soon','coming_soon')->class('control-label') !!}
                    <span class="text-danger">*</span>
                    {!! html()->select('coming_soon', [1 => 'Yes', 0 => 'No'], $data->coming_soon)->class('form-select')->id('coming_soon') !!}
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <span class="text-danger">*</span>
                    {!! html()->select('maintenance', [1 => 'Yes', 0 => 'No'], $data->maintenance)->class('form-select')->id('maintenance') !!}
                </div>
            </div>
        </div>
        <div class="form-group">
    ...
    <div class="col-md-12">
        <div class="form-group">
            {!! html()->label('Define Access','access_group_id')->class('control-label') !!}
            <span class="text-danger">*</span>
                ...
                @foreach($access_group as $key => $value)
                    <div class="col-12">
                        ...
                        <div class="form-control access-menu-crud-{{$key}} m-2">
                            <label class="control-label">Determine Access Rights</label> <span class="text-danger">*</span>
...
<script>
    $('.modal-title').html('<i class="mdi mdi-bookmark-plus"></i> Add Data {{ $page->title }}');
    $('.select2').select2();
