...
<div class="row">
    <div class="col-md-6">
        ...
        <div class="form-group">
            ...
            {!! html()->select('model', $model)->placeholder('Select Model (optional)')->class('form-control select2')->id('model') !!}
        </div>
        <div class="form-group">
    ...
    <div class="col-md-6">
        ...
        <div class="form-group">
            ...
            <span class="text-danger">*</span>
            {!! html()->select('type', ['' => 'Select Menu Type', 'backend' => 'Backend', 'frontend' => 'Frontend'],'backend')->class('form-select')->id('type') !!}
        </div>
        <div class="form-group">
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <span class="text-danger">*</span>
                    {!! html()->select('active', [1 => 'Active', 0 => 'Inactive'], 1)->class('form-select')->id('active') !!}
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <span class="text-danger">*</span>
                    {!! html()->select('show', [1 => 'Yes', 0 => 'No'], 1)->class('form-select')->id('show') !!}
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <span class="text-danger">*</span>
                    {!! html()->select('coming_soon', [1 => 'Yes', 0 => 'No'], 0)->class('form-select')->id('coming_soon') !!}
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <span class="text-danger">*</span>
                    {!! html()->select('maintenance', [1 => 'Yes', 0 => 'No'], 0)->class('form-select')->id('maintenance') !!}
                </div>
            </div>
        </div>
    </div>
    <div class="col-md-12">
        <div class="form-group">
            {!! html()->label('Who can access this menu?','access_group_id')->class('control-label') !!}
            <span class="text-danger">*</span>
