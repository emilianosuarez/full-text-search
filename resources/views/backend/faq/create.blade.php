...
<div class="panel shadow-sm">
    <div class="panel-body">
        <div class='form-group'>
            {!! html()->label('title')->text('Title / Group Name /Faq Name')->class('control-label') !!}
            <span class="text-danger">*</span>
            {!! html()->text('title')->placeholder('Type here ...')->class('form-control')->id('title') !!}
        </div>
        <div class='form-group'>
        ...
        <div class='form-group'>
            ...
            {!! html()->textarea('description')->placeholder('Type here ...')->class('form-control')->id('description') !!}
        </div>
        <div class='form-group'>
